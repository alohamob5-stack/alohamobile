    ...
    <div style={{ minHeight: '100vh', background: '#0f1e3d', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'sans-serif' }}>
      <div style={{ width: '100%', maxWidth: '360px', padding: '1rem' }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', fontFamily: 'var(--font-head)', fontSize: '2rem', fontWeight: '700' }}>
            <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '40px', height: '40px', borderRadius: '12px', background: 'rgba(239,138,28,0.18)', color: '#ef8a1c', flexShrink: 0 }}><Palmtree size={22} /></span>
            <span style={{ color: '#fff' }}>ALOHA<span style={{ color: '#ef8a1c' }}>MOB</span></span>
          </div>
