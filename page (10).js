...
import { User, ShoppingCart, ImageOff, Trash2, Truck, Home as HomeIcon, Package, Search, Banknote, CreditCard, LogOut, Palmtree } from 'lucide-react';
    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)', fontFamily: 'sans-serif', paddingBottom: isMobile ? '65px' : '0' }}>
      ...
      <header style={{ background: '#fff', padding: '0 1rem', position: 'sticky', top: 0, zIndex: 100, boxShadow: '0 2px 16px rgba(15,30,61,0.08)', borderBottom: '1px solid var(--border)' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto', display: 'flex', alignItems: 'center', gap: '0.75rem', height: '56px' }}>
          <button onClick={() => router.back()} style={{ background: '#fff', border: '1.5px solid var(--border)', color: 'var(--black)', cursor: 'pointer', fontSize: '0.85rem', fontWeight: '700', flexShrink: 0, borderRadius: 'var(--pill)', padding: '0.5rem 1rem' }}>← Nazad</button>
          <div onClick={() => router.push('/')} style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', fontFamily: 'var(--font-head)', fontSize: '1.4rem', fontWeight: '700', letterSpacing: '-0.5px', whiteSpace: 'nowrap', color: 'var(--black)', cursor: 'pointer', flexShrink: 0 }}>
                        ...
                        <div key={x.id} style={{ display: 'flex', gap: '1rem', alignItems: 'center', padding: '1rem', background: 'var(--card)', border: '1px solid var(--border)', borderRadius: 'var(--radius)', boxShadow: 'var(--shadow)' }}>
                          ...
                          <div style={{ flex: 1, minWidth: 0 }}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                              <button onClick={() => changeQty(x.id, -1)} style={{ width: '30px', height: '30px', border: '1px solid var(--border)', borderRadius: 'var(--pill)', cursor: 'pointer', background: '#fff', fontWeight: 'bold' }}>−</button>
